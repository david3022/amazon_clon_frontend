      ...
      <div className="flex bg-amazonclone text-white h-[60px]">
        ...
        <div className="flex items-center m-4">
          ...
          <div className="pr-4 pl-4">
            <div className="text-xs xl:text-sm">Developed by</div>
            <div className="text-sm xl:text-base font-bold">David Fajardo</div>
          </div>
        </div>
        {/* Middle */}
        ...
        <div className="flex items-center m-4">
          ...
          <div className="pr-4 pl-4">
            <div className="text-xs xl:text-sm">Linkedin</div>
